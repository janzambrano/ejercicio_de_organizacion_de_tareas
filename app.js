...
let tareasAAgregar = [
    {titulo: "micro Desafío 2", estado: "En Proceso"}
,
    {titulo: "cenar", estado: "Pendiente"}]console.log(archivoTareas.escribirJSON(tareasAAgregar))
...
:
        ...
        tareas.forEach((tarea, index) => {
            console.log('Tarea #', index, "=", tarea.titulo, '/', tarea.estado)
        });
    break;
